...
public class ArkApplicationBuilder: IHostBuilder
{
    ...
    public ArkApplicationBuilder WithTimeProvider<TTime>(Func<IServiceProvider, TTime> configure) where TTime: class, IChainTimeProvider
    {
        _hostBuilder.ConfigureServices(services =>
        {
            services.AddSingleton<IChainTimeProvider, TTime>(configure);
        });
        return this;
    }
